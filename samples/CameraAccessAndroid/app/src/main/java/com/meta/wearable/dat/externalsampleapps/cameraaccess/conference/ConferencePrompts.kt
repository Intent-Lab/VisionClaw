...
""".trimIndent()
    ...
    fun activeSystemInstruction(conferenceModeEnabled: Boolean, fallbackPrompt: String): String {
        return if (conferenceModeEnabled) relationshipOps else fallbackPrompt
    }
}
